...
resp.write("</head>\n");
resp.write("<body>\n");
resp.write("    <p>"+test+"静态成绍勇222html文111件"+abc.tf.a+"</p>\n");
resp.write("    <p>这里是静态");if(test>abc.tf.a){resp.write("123");}resp.write("文件内容");if(test>abc.tf.a){resp.write("456");}resp.write("</p>\n");
